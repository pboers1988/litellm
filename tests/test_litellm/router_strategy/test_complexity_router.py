...
class TestRouterComplexityDeploymentMethods:
    ...
    def test_heuristic_v2_router_limit_violation_frees_the_slot_of_the_router_being_edited(self) -> None:
        ...
        assert router.heuristic_v2_router_limit_violation(exclude_model_id="id-a") is None
        assert router.heuristic_v2_router_limit_violation(exclude_model_id="id-other") is not None
        assert router.heuristic_v2_router_limit_violation() is not None
