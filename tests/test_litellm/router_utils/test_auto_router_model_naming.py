...
def test_count_heuristic_v2_routers_excludes_the_router_being_edited() -> None:
    v2 = {"model": "auto_router/complexity_router", "complexity_router_config": {"classifier_type": "heuristic_v2"}}
    rows: list[Mapping[str, object]] = [
        {"model_name": "a", "litellm_params": v2, "model_info": {"id": "id-a"}},
        {"model_name": "b", "litellm_params": v2, "model_info": {"id": "id-b"}},
    ]
    assert count_heuristic_v2_routers(rows, exclude_model_id="id-a") == 1
    assert count_heuristic_v2_routers(rows, exclude_model_id="id-missing") == 2
